...
AT = [8.6, 23.9E-3, 1.5] #unique
ACorGT = [6.5, 17.3E-3, 1.3] #GT
AGorCT = [7.8, 20.8E-3, 1.6] #CT
TA = [6.0, 16.9E-3, 0.9] #Unique
TCorGA = [5.6, 13.5E-3, 1.6] #GA
TGorCA = [5.8, 12.9E-3, 1.9] #CA
